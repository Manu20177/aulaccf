<?php
	...
	class videoModel extends mainModel{
		...
		public function add_video_model($data){
			...
			$query1=$conexion->prepare("INSERT INTO curso_clase(id_curso,id_clase) VALUES(:Curso,:Clase)");
		...
		public function update_video_model($data){
			...
			$query1=self::connect()->prepare("UPDATE curso_clase SET id_curso=:Curso WHERE id_clase=:Clase");
			$query1->bindParam(":Curso",$data['Curso']);
