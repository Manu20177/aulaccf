...
<?php 
	...
	$query=$insVideo->execute_single_query("SELECT c.* FROM clase c LEFT JOIN preguntas_rapidas pr ON c.id = pr.id_clase WHERE pr.id_clase IS NULL;
				    		...
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										...
										<a href="../archivos/evaluacion/formato_evaluacion.csv">Descargar Plantilla</a>
