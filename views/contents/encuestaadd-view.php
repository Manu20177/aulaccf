...
<?php 
	...
	$query=$insVideo->execute_single_query("SELECT c.* FROM clase c LEFT JOIN encuesta_rapida er ON c.id = er.id_clase 
	WHERE er.id_clase IS NULL;
");
				    		...
				    		<div class="container-fluid">
				    			<div class="row">
									...
									<div class="col-xs-12 col-sm-6">
										...
										<a href="../archivos/encuesta/formato_encuesta.csv">Descargar Plantilla</a>
